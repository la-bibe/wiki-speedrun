...
/* harmony default export */ __webpack_exports__["default"] = ("<input type=\"text\" [(ngModel)]=\"from\"><br/>\n<input type=\"text\" [(ngModel)]=\"to\"><br/>\n<button (click)=\"findLinks()\">Find links</button>\n<div class=\"logger\">\n</div>\n");
...
/* harmony import */ var _services_crawler_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/crawler.service */ "./src/app/services/crawler.service.ts");




let AppComponent = class AppComponent {
    constructor(apiService, crawlerService) {
...
let CrawlerService = class CrawlerService {
    ...
    findPath(lang, from, to) {
        ...
        const crawlNextLevel = toVisit => {
            return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](subscriber => {
                this.apiService.fetchAllPagesLinks(lang, toVisit, to).subscribe(({ page, link }) => {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"](subscriber => {
            ...
            const continueCrawling = () => {
                ...
                unexplored = [];
                crawlNextLevel(toVisit).subscribe(newUnexplored => {
...
CrawlerService.ctorParameters = () => [
    { type: _api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
CrawlerService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], CrawlerService);
...
module.exports = __webpack_require__(/*! /home/neodar/Perso/wiki-speedrun/src/main.ts */"./src/main.ts");
